package com.example.rodrigo.masterdetail.activity;

import android.content.Intent;
import android.os.Bundle;
import android.support.v4.app.FragmentActivity;

import com.example.rodrigo.masterdetail.fragment.ItemDetailFragment;
import com.example.rodrigo.masterdetail.fragment.ItemListFragment;
import com.example.rodrigo.masterdetail.R;
...
public class ItemListActivity extends FragmentActivity implements ItemListFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.item_detail_container) != null) {
            // The detail container view will be present only in the large-screen layouts (res/values-large
            // and res/values-sw600dp). If this view is present, then the activity should be in two-pane mode.
            mTwoPane = true;
